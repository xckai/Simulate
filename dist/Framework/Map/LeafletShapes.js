...
define(["require", "exports", "leaflet"], function (require, exports, L) {
    ...
    exports.ImageMarker = SvgMarker.extend({
        // @section
        // @aka CircleMarker options
        options: {
    ...
    var imageMarker = function (latlng, option) {
        return new exports.ImageMarker(latlng, option);
    };
    exports.CircleMarker = SvgMarker.extend({
        options: {
            stroke: true,
            fill: true,
            type: "circle",
    ...
    var circleMarker = function (latlng, option) {
        return new L.CircleMarker(latlng, option);
    };
    exports.SquareMarker = SvgMarker.extend({
        options: {
            stroke: false,
            fill: true,
            type: "square",
    ...
    var squareMarker = function (latlng, option) {
        return new exports.SquareMarker(latlng, option);
    };
    exports.TextMarker = SvgMarker.extend({
        options: {
            type: "text",
            style: "normal",
    ...
    var textMarker = function (latlng, option) {
        return new exports.TextMarker(latlng, option);
    };
    exports.ArrowMarker = SvgMarker.extend({
        options: {
            type: "arrow",
            width: 10,
            height: 10,
    ...
    var Polygon = (function (_super) {
        ...
        Polygon.prototype.setData = function (d) {
            this._data = d;
        };
